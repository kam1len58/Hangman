...
2. Выполните команду `dotnet publish --self-contained -p:PublishSingleFile=true` для сборки проекта, это позволяет сделать сборку более чистой.
...
Выходные данные после сборки проекта:
